...
public class HandlerDownloadListener implements DownloadListener {
    ...
    public HandlerDownloadListener(int downloadId, DownloadListener mListener) {
    ...
    @Override
    public void onError(int downloadId,Exception e) {
    ...
    @Override
    public void onProgress(int downloadId,long progress, long totalSize) {
        Message msg = Message.obtain();
